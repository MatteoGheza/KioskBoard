...
## Current Version
2.4.0 [*](https://github.com/furcan/KioskBoard/blob/main/CHANGELOG.md)
...
```html
<link rel="stylesheet" href="dist/kioskboard-2.4.0.min.css" />

<script src="dist/kioskboard-2.4.0.min.js"></script>
```

### Or only JS (All in One - Internal CSS)

```html
<script src="dist/kioskboard-aio-2.4.0.min.js"></script>
```
